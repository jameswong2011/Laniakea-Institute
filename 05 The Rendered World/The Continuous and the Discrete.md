...
The furthest consequence is a boundary theorem for machines. A purely digital superintelligence can approximate the continuum to any finite fidelity and can never contain it — the limit that shapes the account of [[Three Routes to Machine Consciousness|machine consciousness]] and [[Uploading and Continuity|uploading]]. The question "continuous base or discrete render?" stays on the register of [[The Open Tensions|open tensions]].
