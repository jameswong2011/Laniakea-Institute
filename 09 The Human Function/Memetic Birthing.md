...
New ideas can be made on purpose. A meme (a unit of culture that copies from mind to mind) is birthed through a kind of mental womb, by honest truth-seeking; luck has nothing to do with it. Three procedures do the work.
...
Every new meme is then weighed on three axes. Does it raise total positive [[Qualia|felt experience]], or just move pain elsewhere? Does it make real novelty, or a cosmetic reshuffle? Does it keep the minimum order people need to keep collaborating?

The full art is decomposition and reconstruction: a memeplex (a bundle of ideas that travel together, like a whole ideology or religion) is broken into its elementary values, causal claims, emotional rewards, and identity functions, then rebuilt into several stable configurations. A concept is understood only when it can be rebuilt differently without losing the truth that made it useful — a mechanic has not learned an engine until they can reassemble it in a new layout that still runs. This is the constructive twin of [[Art as Selective Recombination|artistic recombination]] and the engine behind [[The Glue Species|the glue species]].
